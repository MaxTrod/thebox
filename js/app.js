(() => {
    ...
    function initSliders() {
        if (document.querySelector(".slider-big")) bigSlider = new swiper_core_Swiper(".slider-big", {
        ...
        if (document.querySelector(".slider-mini")) miniSlider = new swiper_core_Swiper(".slider-mini", {
        ...
        if (document.querySelector(".body-projects__slider")) cards = new swiper_core_Swiper(".body-projects__slider", {
    ...
    function addImage() {
        ...
        if (itemExperience.length > 4) itemExperience.forEach((function(item, index) {
            if (index === 3) item.classList.add("item-experience--reset");
        }));
    }
    function menuActive() {
        ...
        function menuActions(e) {
            ...
            if (menuItem.closest(".navigation-projects__item")) {
                ...
                const menuActiveItem = menu.querySelector(".navigation-projects__item._active");
                if (!menuParentItem.classList.contains("_active")) menuActiveItem ? menuActiveItem.classList.remove("_active") : null;
    ...
    function inputStar() {
        ...
        inputs.forEach((input => {
            input.addEventListener("focusin", (function(e) {
                const targetElement = e.target;
                if (targetElement.tagName === "INPUT") targetElement.parentElement.classList.add("no-star");
            }));
            input.addEventListener("focusout", (function(e) {
                const targetElement = e.target;
                if (targetElement.tagName === "INPUT" & targetElement.value.length === 0) targetElement.parentElement.classList.remove("no-star");
            }));
        }));
    }
